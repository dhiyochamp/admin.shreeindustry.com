...
import { FaEnvelope, FaLock, FaEye, FaEyeSlash, FaCheck, FaCopy, FaArrowLeft, FaCrown } from "react-icons/fa";
...
export default function Login() {
  ...
  const [planLabel, setPlanLabel] = useState('6 Months - ₹3,000/month (₹18,000)');
  ...
  }, [selectedPlan, showPaymentScreen, paymentCompleted]);
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">Admin Dashboard</h1>
          <p className="text-gray-600 md:text-lg">Access your administration tools</p>
        </div>
            ...
            showPaymentSuccess ? (
              <div className="p-6 md:p-10 text-center">
                <div className="w-20 h-20 md:w-24 md:h-24 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
                  <FaCheck className="text-green-500 text-3xl md:text-4xl" />
                </div>
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Payment Successful!</h2>
                <button
                  onClick={() => {
                    setShowPaymentSuccess(false);
                    setShowPaymentScreen(false);
                  }}
                  className="w-full max-w-md mx-auto bg-blue-600 hover:bg-blue-700 text-white py-3 md:py-4 px-6 rounded-xl transition duration-300"
                >
                  Continue to Login
                </button>
              </div>
              ...
              <div className="p-6 md:p-8">
                <div className="flex flex-col md:flex-row justify-between items-start mb-6 gap-4">
                  <div>
                    <h2 className="text-xl md:text-3xl font-bold text-gray-800 mb-2 flex items-center">
                ...
                <div className="bg-blue-50 p-6 rounded-2xl mb-6">
                        ...
                        <div className="flex-1">
                          <div className="bg-white p-4 rounded-xl mb-4">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex-1 bg-gray-50 px-3 py-2 rounded">
                                <code className="truncate">{upiId}</code>
                              </div>
                              <button 
                                onClick={copyUpiId} 
                          ...
                          <div className="grid grid-cols-3 gap-2 md:grid-cols-5">
                            {paymentApps.map((app, index) => (
                              <div 
                                key={index} 
                                className="p-3 bg-white rounded-lg border border-gray-100 flex flex-col items-center justify-center hover:shadow-md transition-all"
                  ...
                  >
                    {paymentVerifying ? 'Verifying...' : "I've Paid"}
                  </button>
                </div>
              </div>
            )
